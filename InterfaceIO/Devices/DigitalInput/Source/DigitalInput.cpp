...
namespace InterfaceIO
{
	namespace Devices
	{
		DigitalInput::DigitalInput(IDigitalInputDriverSPtr pDriver, Core::ITaskQueueSPtr pTaskQueue)
		...
		bool DigitalInput::GetState()
		{
			...
			const auto pCallback = std::make_shared<Core::AsyncClassCallback<DigitalInput, bool>>(
